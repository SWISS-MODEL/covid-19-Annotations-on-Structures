...
class UniprotBasedMapping:
    ...
    def list_available_proteins(self):
        print('\n'.join(list(self.protein_intervals.keys())))
    ...
    def _get_intervals_from_uniprot(self):
        ...
        for line in gff_lines:
            ...
            if len(note):
                ...
                self.protein_intervals[protein_id] = _range
            else:
                continue

    def search_pdbs_by_protein_name(self, protein_name):
        try:
            start, end = self.protein_intervals[protein_name]
        except KeyError:
...
if __name__ == "__main__":
    ...
    mapping.list_available_proteins()
    print(mapping.search_pdbs_by_protein_name("Spike protein S3"))
    # mapping.protein_intervals["3C-like proteinase"]